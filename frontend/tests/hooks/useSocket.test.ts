...
jest.mock('../../src/store/slices/connectionSlice.js', () => ({
...
describe('useSocket', () => {
  ...
  describe('initialization', () => {
    it('should dispatch initSocket when connection status is disconnected', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'connection/initSocket' });
    });
    ...
    it('should not dispatch initSocket when already connected', () => {
      ...
      expect(mockDispatch).not.toHaveBeenCalledWith({ type: 'connection/initSocket' });
    });
  ...
  describe('cleanup', () => {
    it('should dispatch disconnectSocket on unmount', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'connection/disconnectSocket' });
    });
